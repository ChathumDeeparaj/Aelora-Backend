...
async function seed() {
  try {
    ...
    const endDate = new Date("2025-12-09T12:30:00Z"); // December 09, 2025 12:30pm UTC (6:00pm Sri Lanka time)
    ...
    console.log(
      `Database seeded successfully. Generated ${recordCount} energy generation records from August 1, 2025 8pm to December 09, 2025 6pm (Sri Lanka time).`
    );
  } catch (err) {
